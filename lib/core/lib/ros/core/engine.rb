        ...
        if Settings.metrics.enabled
          ...
          if Sidekiq.server?
            Sidekiq.configure_server do |config|
              ...
              # Sometimes Sidekiq shuts down before it can send metrics
              # generated right before shutdown to collector. If you care about
              # the sidekiq_restarted_jobs_total metric it is a good idea to
